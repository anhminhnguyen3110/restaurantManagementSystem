...
public class UserListView extends JPanel {
    ...
    public UserListView() {
        ...
        filters.add(new JLabel("Username:")); filters.add(txtUsername);
        filters.add(new JLabel("Email:")); filters.add(txtEmail);
        filters.add(new JLabel("Role:"));
        cmbRole.addItem(null);
        for (UserRole r : UserRole.values()) cmbRole.addItem(r);
        filters.add(cmbRole);
        filters.add(btnReset); filters.add(btnAdd); filters.add(btnDel);
        ...
        cmbRole.addItemListener(e -> { if (e.getStateChange()==ItemEvent.SELECTED) applyFilters(); });
