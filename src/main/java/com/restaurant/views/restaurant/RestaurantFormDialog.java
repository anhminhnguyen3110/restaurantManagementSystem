...
public class RestaurantFormDialog extends JDialog {
    ...
    private void buildUI() {
        ...
        f.add(new JLabel("Name:"));      f.add(txtName);
        f.add(new JLabel("Address:"));   f.add(txtAddress);
        if (existing!=null) {
            f.add(new JLabel("Status:")); f.add(cmbStatus);
        }
        f.add(new JLabel("Map Width (X):"));  f.add(spnMaxX);
        f.add(new JLabel("Map Height (Y):")); f.add(spnMaxY);
