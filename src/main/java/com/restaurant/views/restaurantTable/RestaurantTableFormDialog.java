...
public class RestaurantTableFormDialog extends JDialog {
    ...
    private void buildUI() {
        ...
        form.add(new JLabel("Table #:"));  form.add(spnNumber);
        form.add(new JLabel("Capacity:")); form.add(spnCapacity);
        form.add(new JLabel("Start X:"));  form.add(spnStartX);
        form.add(new JLabel("Start Y:"));  form.add(spnStartY);
        form.add(new JLabel("End X:"));    form.add(spnEndX);
        form.add(new JLabel("End Y:"));    form.add(spnEndY);
    ...
    private void onSave() {
        ...
        if (existing == null) {
            ...
            List<String> errs = RestaurantTableInputValidator.validate(dto);
            if (!errs.isEmpty()) {
