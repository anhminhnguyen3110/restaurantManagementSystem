...
public class OrderItemListView extends JPanel {
    ...
    public OrderItemListView(Order order, Runnable onUpdated) {
        ...
        cbRestaurantFilter.addItemListener(e -> {
            if (e.getStateChange() == ItemEvent.SELECTED) applyFilters();
        });
    ...
    private void applyFilters() {
        try {
            dto.setId(Integer.parseInt(txtIdFilter.getText().trim()));
    ...
    private void resetFilters() {
        ...
        dto.setId(0);
        dto.setMenuItemName(null);
        dto.setStatus(null);
        Restaurant sel = (Restaurant) cbRestaurantFilter.getSelectedItem();
        dto.setRestaurantId(sel != null ? sel.getId() : 0);
        dto.setSortBy("id");
        dto.setSortDir("asc");
        dto.setPage(0);
    }
