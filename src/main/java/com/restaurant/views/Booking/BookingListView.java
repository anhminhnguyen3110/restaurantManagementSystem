...
public class BookingListView extends JPanel {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (key != null) {
                    if (key.equals(currentDto.getSortBy())) {
                        currentDto.setSortDir(
                                currentDto.getSortDir().equals("asc") ? "desc" : "asc"
                        );
                    } else {
    ...
    private void applyFilters() {
        currentDto.setDate(dpDate.getDate() == null ? null
    ...
    private Booking getSelected() {
        ...
        if (r < 0) {
            JOptionPane.showMessageDialog(
                    this, "Please select a booking.", "Info", JOptionPane.INFORMATION_MESSAGE
            );
            return null;
        }
